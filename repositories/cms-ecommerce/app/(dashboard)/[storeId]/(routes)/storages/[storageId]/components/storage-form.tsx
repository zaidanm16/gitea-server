...
const StorageForm: React.FC<StorageFormProps> = ({ initialData }) => {
  ...
  const description = initialData ? "Edit a Storage" : "Add a Storage";
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Make sure you removed all categories using this Storage first."
      );
    } finally {
      setOpen(false);
      setLoading(false);
